...
function printStrings(array) {
  ...
  console.log(array.toString().trim() + array.toString().trim());
}
...
function addTenToEach(array) {
  // Ініціалізуємо масив через конструктор з такою же кількістю елементів як в вхідному масиві для зберігання результатуq
